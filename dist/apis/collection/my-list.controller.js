...
let MyListController = class MyListController {
    ...
    async myListMinusPosting(postId, data) {
...
__decorate([
    (0, common_1.Post)('/collections/add/:postId'),
...
__decorate([
    ...
    __param(1, (0, decorators_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, minus_bookmark_posting_dto_1.minusCollectionPostingDto]),
    __metadata("design:returntype", Promise)
